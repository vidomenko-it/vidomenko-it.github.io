...
tags:
  ...
  - Proxmox
---
# 2. Про один з способів реалізації RAID1 спільного сховища для кластера Proxmox з двох вузлів з їх дисків.
...
```
### 3.3. Підготовка дисків (зміна розміру кластера за потреби) 
...
### 4.2. На першому вузлі підєднуємось до віртуальної машини, ми знаходимо ціль і входимо в систему:
